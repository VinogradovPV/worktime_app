...
const rawBundleId = "com.app.worktime_app";
const bundleId =
  rawBundleId
...
const env = {
  ...
  appName: "Worktime",
  appSlug: "worktime_app",
  // S3 URL of the app logo - set this to the URL returned by generate_image when creating custom logo
  // Leave empty to use the default icon from assets/images/icon.png
  logoUrl: "https://d2xsxph8kpxj0f.cloudfront.net/310519663716903033/PdfMHWoZXxV97aokp6vmmh/icon-FUZL7cdVMRnCBB7eXJQao8.png",
