...
- **Логика:** Сбросить пароль пользователя
...
| **Auth endpoints** | ⏳ Ожидает | Нужно реализовать на FastAPI |
| **Admin endpoints** | ⏳ Ожидает | Нужно реализовать на FastAPI |
| **Справочники** | ⏳ Ожидает | Нужно реализовать на FastAPI |
| **Синхронизация** | ⏳ Ожидает | Нужно реализовать на FastAPI |
